...
$homePath = rtrim($_SERVER['HOME'], DIRECTORY_SEPARATOR);
$trashPath = $homePath . '/.trash/';
$trashTmbPath = $trashPath . '.tmb/';

if (!is_dir($trashPath)) {
	@mkdir($trashPath, 0775, true);
}
if (!is_dir($trashTmbPath)) {
	@mkdir($trashTmbPath, 0775, true);
}
...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'path'          => $_SERVER['HOME'],                 // path to files (REQUIRED)
